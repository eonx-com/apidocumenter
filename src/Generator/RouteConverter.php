...
use LoyaltyCorp\ApiDocumenter\Generator\Exceptions\RouteConversionFailedException;
use LoyaltyCorp\ApiDocumenter\Generator\Interfaces\RouteConverterInterface;
use LoyaltyCorp\ApiDocumenter\Routing\Route;

final class RouteConverter implements RouteConverterInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    private function processRoute(Route $route): Operation
    {
        ...
        if (\is_string($route->getRequestType()) === true) {
            $ref = \LoyaltyCorp\ApiDocumenter\Generator\buildReference($route->getRequestType());
        ...
        if (\is_string($route->getResponseType()) === true) {
            $ref = \LoyaltyCorp\ApiDocumenter\Generator\buildReference($route->getResponseType());
